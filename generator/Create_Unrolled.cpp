...
static QuartetSet GenerateInitialTargets(std::array<int, 4> amlst)
{
    QuartetSet qs;
...
static void PruneRight(QuartetSet & qs, DoubletType type)
{
    QuartetSet qsnew;
...
static void HRRLoop(HRRStepList & hrrlist,
...
static void PrintQuartetSet(const QuartetSet & q,
