...
/////////////////////////////
// Basic OSTEI Writer for
// first derivatives
/////////////////////////////
void OSTEIDeriv1_Writer_Basic::DeclareContwork(void) const
{
...
void OSTEIDeriv1_Writer_Basic::ZeroContwork(void) const
{
...
void OSTEIDeriv1_Writer_Basic::FreeContwork(void) const
{
    size_t contmem = info_.ContMemoryReq();
...
void OSTEIDeriv1_Writer_Basic::WriteShellOffsets(void) const
{
...
void OSTEIDeriv1_Writer_Basic::WriteShellOffsets_Scalar(void) const
{
...
void OSTEIDeriv1_Writer_Basic::WriteAccumulation(void) const
{
    os_ << "\n\n";
    os_ << indent5 << "////////////////////////////////////\n";
...
void OSTEIDeriv1_Writer_Basic::WriteFile_Permute_(void) const
{
    ...
    std::string funcline = StringBuilder("int ostei_deriv1_sharedwork_", amchar[am[0]], "_", amchar[am[1]], "_" , amchar[am[2]], "_", amchar[am[3]], "(");
    std::string indent(funcline.length(), ' ');

    // start output to the file
    // we only need this one include
    os_ << "#include \"simint/ostei/gen/ostei_deriv1_generated.h\"\n";
    os_ << "\n";
    ...
    os_ << indent1 << "return ostei_deriv1_sharedwork_" 
                                               << amchar[tocall[0]] << "_"
                                               << amchar[tocall[1]] << "_" 
                                               << amchar[tocall[2]] << "_" 
...
void OSTEIDeriv1_Writer_Basic::WriteFile_NoPermute_(void) const
{
...
void OSTEIDeriv1_Writer_Basic::WriteFile(void) const
{
    const QAM am = info_.FinalAM();
    ...
    // note - no return type
    std::string funcline = StringBuilder("ostei_deriv1_sharedwork_", amchar[am[0]], "_", amchar[am[1]], "_" , amchar[am[2]], "_", amchar[am[3]], "(");
    std::string funcline2 = StringBuilder("ostei_deriv1_", amchar[am[0]], "_", amchar[am[1]], "_" , amchar[am[2]], "_", amchar[am[3]], "(");
