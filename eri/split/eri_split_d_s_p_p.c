                      ...
                      double * const restrict INT__d_s_p_p)
{
    ...
    for(abcd = 0; abcd < nshell1234; ++abcd)
    {
        for(ibra = 0; ibra < 6; ++ibra)
        {
            ...
            INT__d_s_p_p[abcd * 54 + ibra * 9 + 0] = INT__d_s_d_s[abcd * 36 + ibra * 6 + 0] + ( CD_x[abcd] * INT__d_s_p_s[abcd * 18 + ibra * 3 + 0] );

            // |P_100 P_010)_{i} = |D_110 S_000)_{t} + y_cd * |P_100 S_000)_{t}
            INT__d_s_p_p[abcd * 54 + ibra * 9 + 1] = INT__d_s_d_s[abcd * 36 + ibra * 6 + 1] + ( CD_y[abcd] * INT__d_s_p_s[abcd * 18 + ibra * 3 + 0] );

            // |P_100 P_001)_{i} = |D_101 S_000)_{t} + z_cd * |P_100 S_000)_{t}
            INT__d_s_p_p[abcd * 54 + ibra * 9 + 2] = INT__d_s_d_s[abcd * 36 + ibra * 6 + 2] + ( CD_z[abcd] * INT__d_s_p_s[abcd * 18 + ibra * 3 + 0] );

            // |P_010 P_100)_{i} = |D_110 S_000)_{t} + x_cd * |P_010 S_000)_{t}
            INT__d_s_p_p[abcd * 54 + ibra * 9 + 3] = INT__d_s_d_s[abcd * 36 + ibra * 6 + 1] + ( CD_x[abcd] * INT__d_s_p_s[abcd * 18 + ibra * 3 + 1] );

            // |P_010 P_010)_{i} = |D_020 S_000)_{t} + y_cd * |P_010 S_000)_{t}
            INT__d_s_p_p[abcd * 54 + ibra * 9 + 4] = INT__d_s_d_s[abcd * 36 + ibra * 6 + 3] + ( CD_y[abcd] * INT__d_s_p_s[abcd * 18 + ibra * 3 + 1] );

            // |P_010 P_001)_{i} = |D_011 S_000)_{t} + z_cd * |P_010 S_000)_{t}
            INT__d_s_p_p[abcd * 54 + ibra * 9 + 5] = INT__d_s_d_s[abcd * 36 + ibra * 6 + 4] + ( CD_z[abcd] * INT__d_s_p_s[abcd * 18 + ibra * 3 + 1] );

            // |P_001 P_100)_{i} = |D_101 S_000)_{t} + x_cd * |P_001 S_000)_{t}
            INT__d_s_p_p[abcd * 54 + ibra * 9 + 6] = INT__d_s_d_s[abcd * 36 + ibra * 6 + 2] + ( CD_x[abcd] * INT__d_s_p_s[abcd * 18 + ibra * 3 + 2] );

            // |P_001 P_010)_{i} = |D_011 S_000)_{t} + y_cd * |P_001 S_000)_{t}
            INT__d_s_p_p[abcd * 54 + ibra * 9 + 7] = INT__d_s_d_s[abcd * 36 + ibra * 6 + 4] + ( CD_y[abcd] * INT__d_s_p_s[abcd * 18 + ibra * 3 + 2] );

            // |P_001 P_001)_{i} = |D_002 S_000)_{t} + z_cd * |P_001 S_000)_{t}
            INT__d_s_p_p[abcd * 54 + ibra * 9 + 8] = INT__d_s_d_s[abcd * 36 + ibra * 6 + 5] + ( CD_z[abcd] * INT__d_s_p_s[abcd * 18 + ibra * 3 + 2] );
