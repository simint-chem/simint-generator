...
int eri_split_d_p_p_p(struct multishell_pair const P,
                      ...
                      double * const restrict S_2_1_1_1)
{
    ...
    memset(S_2_1_1_1, 0, nshell1234*162*sizeof(double));
    ...
    double * const S_2_1_1_0 = contwork + (nshell1234 * 54);
    double * const S_2_1_2_0 = contwork + (nshell1234 * 108);
    double * const S_3_0_1_0 = contwork + (nshell1234 * 216);
    double * const S_3_0_2_0 = contwork + (nshell1234 * 246);
    ...
    for(abcd = 0; abcd < nshell1234; ++abcd)
    {
        for(int ibra = 0; ibra < 18; ++ibra)
        {
            ...
            S_2_1_1_1[abcd * 162 + ibra * 9 + 0] = S_2_1_2_0[abcd * 108 + ibra * 6 + 0] + ( CD_x[abcd] * S_2_1_1_0[abcd * 54 + ibra * 3 + 0] );

            // |P_100 P_010)_{i} = |D_110 S_000)_{t} + y_cd * |P_100 S_000)_{t}
            S_2_1_1_1[abcd * 162 + ibra * 9 + 1] = S_2_1_2_0[abcd * 108 + ibra * 6 + 1] + ( CD_y[abcd] * S_2_1_1_0[abcd * 54 + ibra * 3 + 0] );

            // |P_100 P_001)_{i} = |D_101 S_000)_{t} + z_cd * |P_100 S_000)_{t}
            S_2_1_1_1[abcd * 162 + ibra * 9 + 2] = S_2_1_2_0[abcd * 108 + ibra * 6 + 2] + ( CD_z[abcd] * S_2_1_1_0[abcd * 54 + ibra * 3 + 0] );

            // |P_010 P_100)_{i} = |D_110 S_000)_{t} + x_cd * |P_010 S_000)_{t}
            S_2_1_1_1[abcd * 162 + ibra * 9 + 3] = S_2_1_2_0[abcd * 108 + ibra * 6 + 1] + ( CD_x[abcd] * S_2_1_1_0[abcd * 54 + ibra * 3 + 1] );

            // |P_010 P_010)_{i} = |D_020 S_000)_{t} + y_cd * |P_010 S_000)_{t}
            S_2_1_1_1[abcd * 162 + ibra * 9 + 4] = S_2_1_2_0[abcd * 108 + ibra * 6 + 3] + ( CD_y[abcd] * S_2_1_1_0[abcd * 54 + ibra * 3 + 1] );

            // |P_010 P_001)_{i} = |D_011 S_000)_{t} + z_cd * |P_010 S_000)_{t}
            S_2_1_1_1[abcd * 162 + ibra * 9 + 5] = S_2_1_2_0[abcd * 108 + ibra * 6 + 4] + ( CD_z[abcd] * S_2_1_1_0[abcd * 54 + ibra * 3 + 1] );

            // |P_001 P_100)_{i} = |D_101 S_000)_{t} + x_cd * |P_001 S_000)_{t}
            S_2_1_1_1[abcd * 162 + ibra * 9 + 6] = S_2_1_2_0[abcd * 108 + ibra * 6 + 2] + ( CD_x[abcd] * S_2_1_1_0[abcd * 54 + ibra * 3 + 2] );

            // |P_001 P_010)_{i} = |D_011 S_000)_{t} + y_cd * |P_001 S_000)_{t}
            S_2_1_1_1[abcd * 162 + ibra * 9 + 7] = S_2_1_2_0[abcd * 108 + ibra * 6 + 4] + ( CD_y[abcd] * S_2_1_1_0[abcd * 54 + ibra * 3 + 2] );

            // |P_001 P_001)_{i} = |D_002 S_000)_{t} + z_cd * |P_001 S_000)_{t}
            S_2_1_1_1[abcd * 162 + ibra * 9 + 8] = S_2_1_2_0[abcd * 108 + ibra * 6 + 5] + ( CD_z[abcd] * S_2_1_1_0[abcd * 54 + ibra * 3 + 2] );
