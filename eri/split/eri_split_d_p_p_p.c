                      ...
                      double * const restrict S_2_1_1_1)
{
    ...
    double * const restrict S_2_1_1_0 = contwork + (nshell1234 * 54);
    double * const restrict S_2_1_2_0 = contwork + (nshell1234 * 108);
    double * const restrict S_3_0_1_0 = contwork + (nshell1234 * 216);
    double * const restrict S_3_0_2_0 = contwork + (nshell1234 * 246);
