...
int eri_split_d_d_p_p(struct multishell_pair const P,
                      ...
                      double * const restrict S_2_2_1_1)
{
    ...
    memset(S_2_2_1_1, 0, nshell1234*324*sizeof(double));
    ...
    double * const S_2_2_1_0 = contwork + (nshell1234 * 54);
    double * const S_2_2_2_0 = contwork + (nshell1234 * 162);
    double * const S_3_0_1_0 = contwork + (nshell1234 * 378);
    double * const S_3_0_2_0 = contwork + (nshell1234 * 408);
    double * const S_4_0_1_0 = contwork + (nshell1234 * 468);
    double * const S_4_0_2_0 = contwork + (nshell1234 * 513);
    ...
    for(ab = 0, abcd = 0; ab < P.nshell12; ++ab)
    {
        ...
        double * const restrict PRIM_S_3_0_1_0 = S_3_0_1_0 + (abcd * 30);
        double * const restrict PRIM_S_3_0_2_0 = S_3_0_2_0 + (abcd * 60);
        double * const restrict PRIM_S_4_0_1_0 = S_4_0_1_0 + (abcd * 45);
        double * const restrict PRIM_S_4_0_2_0 = S_4_0_2_0 + (abcd * 90);
            ...
            for(i = abstart; i < abend; ++i)
            {
                for(j = cdstart; j < cdend; ++j)
                {
                    ...
                    // Accumulating in contracted workspace
                    for(int i = 0; i < 30; i++)
                        PRIM_S_3_0_1_0[i] += AUX_S_3_0_1_0[i];
                    ...
                    // Accumulating in contracted workspace
                    for(int i = 0; i < 45; i++)
                        PRIM_S_4_0_1_0[i] += AUX_S_4_0_1_0[i];
    ...
    for(abcd = 0; abcd < nshell1234; ++abcd)
    {
        for(int ibra = 0; ibra < 36; ++ibra)
        {
            ...
            S_2_2_1_1[abcd * 324 + ibra * 9 + 0] = S_2_2_2_0[abcd * 216 + ibra * 6 + 0] + ( CD_x[abcd] * S_2_2_1_0[abcd * 108 + ibra * 3 + 0] );

            // |P_100 P_010)_{i} = |D_110 S_000)_{t} + y_cd * |P_100 S_000)_{t}
            S_2_2_1_1[abcd * 324 + ibra * 9 + 1] = S_2_2_2_0[abcd * 216 + ibra * 6 + 1] + ( CD_y[abcd] * S_2_2_1_0[abcd * 108 + ibra * 3 + 0] );

            // |P_100 P_001)_{i} = |D_101 S_000)_{t} + z_cd * |P_100 S_000)_{t}
            S_2_2_1_1[abcd * 324 + ibra * 9 + 2] = S_2_2_2_0[abcd * 216 + ibra * 6 + 2] + ( CD_z[abcd] * S_2_2_1_0[abcd * 108 + ibra * 3 + 0] );

            // |P_010 P_100)_{i} = |D_110 S_000)_{t} + x_cd * |P_010 S_000)_{t}
            S_2_2_1_1[abcd * 324 + ibra * 9 + 3] = S_2_2_2_0[abcd * 216 + ibra * 6 + 1] + ( CD_x[abcd] * S_2_2_1_0[abcd * 108 + ibra * 3 + 1] );

            // |P_010 P_010)_{i} = |D_020 S_000)_{t} + y_cd * |P_010 S_000)_{t}
            S_2_2_1_1[abcd * 324 + ibra * 9 + 4] = S_2_2_2_0[abcd * 216 + ibra * 6 + 3] + ( CD_y[abcd] * S_2_2_1_0[abcd * 108 + ibra * 3 + 1] );

            // |P_010 P_001)_{i} = |D_011 S_000)_{t} + z_cd * |P_010 S_000)_{t}
            S_2_2_1_1[abcd * 324 + ibra * 9 + 5] = S_2_2_2_0[abcd * 216 + ibra * 6 + 4] + ( CD_z[abcd] * S_2_2_1_0[abcd * 108 + ibra * 3 + 1] );

            // |P_001 P_100)_{i} = |D_101 S_000)_{t} + x_cd * |P_001 S_000)_{t}
            S_2_2_1_1[abcd * 324 + ibra * 9 + 6] = S_2_2_2_0[abcd * 216 + ibra * 6 + 2] + ( CD_x[abcd] * S_2_2_1_0[abcd * 108 + ibra * 3 + 2] );

            // |P_001 P_010)_{i} = |D_011 S_000)_{t} + y_cd * |P_001 S_000)_{t}
            S_2_2_1_1[abcd * 324 + ibra * 9 + 7] = S_2_2_2_0[abcd * 216 + ibra * 6 + 4] + ( CD_y[abcd] * S_2_2_1_0[abcd * 108 + ibra * 3 + 2] );

            // |P_001 P_001)_{i} = |D_002 S_000)_{t} + z_cd * |P_001 S_000)_{t}
            S_2_2_1_1[abcd * 324 + ibra * 9 + 8] = S_2_2_2_0[abcd * 216 + ibra * 6 + 5] + ( CD_z[abcd] * S_2_2_1_0[abcd * 108 + ibra * 3 + 2] );
