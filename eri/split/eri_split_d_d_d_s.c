                      ...
                      double * const restrict INT__d_d_d_s)
{
    ...
    double * const contwork = malloc(nshell1234 * 1488);
    memset(contwork, 0, nshell1234 * 1488);

    // partition workspace into shells
    double * const INT__d_s_d_s = contwork + (nshell1234 * 0);
    double * const INT__f_s_d_s = contwork + (nshell1234 * 36);
    double * const INT__g_s_d_s = contwork + (nshell1234 * 96);
