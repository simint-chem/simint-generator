                        ...
                        double * const restrict S_0_0_0_1)
{
    ...
    memset(S_0_0_0_1, 0, nshell1234*3*sizeof(double));
        ...
        for(cd = 0; cd < Q.nshell12; ++cd, ++abcd)
        {
            ...
            for(i = abstart; i < abend; ++i)
            {
                for(j = cdstart; j < cdend; ++j)
                {
                    ...
                    // ( S_000 S_000 | P_100 S_000 )^0_{t} = x * ( S_000 S_000 | S_000 S_000 )^0_{e} - ( P_100 S_000 | S_000 S_000 )^0_{e}
                    S_0_0_1_0[abcd * 3 + 0] += etfac[0] * AUX_S_0_0_0_0[0] - p_over_q * AUX_S_1_0_0_0[0];

                    // ( S_000 S_000 | P_010 S_000 )^0_{t} = y * ( S_000 S_000 | S_000 S_000 )^0_{e} - ( P_010 S_000 | S_000 S_000 )^0_{e}
                    S_0_0_1_0[abcd * 3 + 1] += etfac[1] * AUX_S_0_0_0_0[0] - p_over_q * AUX_S_1_0_0_0[1];

                    // ( S_000 S_000 | P_001 S_000 )^0_{t} = z * ( S_000 S_000 | S_000 S_000 )^0_{e} - ( P_001 S_000 | S_000 S_000 )^0_{e}
    ...
    for(abcd = 0; abcd < nshell1234; ++abcd)
    {
        ...
        {
            // |S_000 P_100)_{i} = |P_100 S_000)_{t} + x_cd * |S_000 S_000)_{t}
            S_0_0_0_1[abcd * 3 + abi * 1 + 0] = S_0_0_1_0[abcd * 3 + abi * 1 + 0] + ( CD_x[abcd] * S_0_0_0_0[abcd * 1 + abi * 1 + 0] );

            // |S_000 P_010)_{i} = |P_010 S_000)_{t} + y_cd * |S_000 S_000)_{t}
            S_0_0_0_1[abcd * 3 + abi * 1 + 1] = S_0_0_1_0[abcd * 3 + abi * 1 + 1] + ( CD_y[abcd] * S_0_0_0_0[abcd * 1 + abi * 1 + 0] );

            // |S_000 P_001)_{i} = |P_001 S_000)_{t} + z_cd * |S_000 S_000)_{t}
            S_0_0_0_1[abcd * 3 + abi * 1 + 2] = S_0_0_1_0[abcd * 3 + abi * 1 + 2] + ( CD_z[abcd] * S_0_0_0_0[abcd * 1 + abi * 1 + 0] );
