                        ...
                        double * const restrict S_2_1_2_1)
{
    ...
    memset(S_2_1_2_1, 0, nshell1234*324*sizeof(double));
    ...
    double S_2_1_2_0[nshell1234 * 108];
    memset(S_2_1_2_0, 0, (nshell1234 * 108) * sizeof(double));

    double S_2_1_3_0[nshell1234 * 180];
    memset(S_2_1_3_0, 0, (nshell1234 * 180) * sizeof(double));
                ...
                for(j = cdstart; j < cdend; ++j)
                {
                    ...
                    AUX_S_0_0_0_0[5] = allprefac
                             * pow(
                                     (
                                       (
                                                   0.646630038500837714
                                         + F_x * ( -0.0182430126939650534
                                         + F_x * ( 0.00543969649877461546
                                         + F_x * ( 0.000116476317051295638
                                         + F_x * ( 0.000021521931928403257
                                         + F_x * ( 1.18615991212530143e-6
                                         + F_x * ( 7.58604696784467546e-8
                                         + F_x * ( 4.92699461286368605e-9
                                         + F_x * ( 1.70136633738363635e-11
                                         + F_x * ( 3.88505787621294195e-11
                                         + F_x * ( -3.02592533985388176e-12
                                         + F_x * ( 2.50393836693133557e-13
                                         + F_x * ( -8.85454095669162848e-15
                                         + F_x * ( 1.84699348446812487e-16
                                                 )))))))))))))
                                       )
                                       /
                                       (
                                                   1.0
                                         + F_x * ( 0.125633711312370486
                                         + F_x * ( 0.0143284143238659723
                                         + F_x * ( 0.00146343159568277208
                                         + F_x * ( 0.000128918603936083915
                                         + F_x * ( 0.000010007581130819214
                                         + F_x * ( 6.93879268824586396e-7
                                         + F_x * ( 4.13381482366787712e-8
                                         + F_x * ( 2.72711915007782649e-9
                                         + F_x * ( 9.35871296778309097e-12
                                         + F_x * ( 2.1459232544492312e-11
                                         + F_x * ( -1.67136625542074901e-12
                                         + F_x * ( 1.38304703720495406e-13
                                         + F_x * ( -4.89079394108677387e-15
                                         + F_x * ( 1.02018439882235746e-16
                                                 ))))))))))))))
                                       )
                                     ), 5.0+0.5);
                    ...
                    AUX_S_0_0_0_0[6] = allprefac
                             * pow(
                                     (
                                       (
                                                   0.673944447579473152
                                         + F_x * ( -0.0273598561147759079
                                         + F_x * ( 0.00463673728289017182
                                         + F_x * ( 0.000034300910503431443
                                         + F_x * ( 0.0000130358950567361568
                                         + F_x * ( 5.83220590433158958e-7
                                         + F_x * ( 3.44797426304112356e-8
                                         + F_x * ( 2.38474353380293983e-9
                                         + F_x * ( -4.59196255955898238e-11
                                         + F_x * ( 1.99099603278533646e-11
                                         + F_x * ( -1.4311498242876518e-12
                                         + F_x * ( 8.80013303476364236e-14
                                         + F_x * ( -2.42311703012800209e-15
                                         + F_x * ( 3.49581150650835651e-17
                                                 )))))))))))))
                                       )
                                       /
                                       (
                                                   1.0
                                         + F_x * ( 0.0927367286140731619
                                         + F_x * ( 0.00931025853766456165
                                         + F_x * ( 0.000851628757507340205
                                         + F_x * ( 0.0000670090595547958342
                                         + F_x * ( 4.69316257859672114e-6
                                         + F_x * ( 2.97608095074209198e-7
                                         + F_x * ( 1.57040009441295436e-8
                                         + F_x * ( 1.11345155312273823e-9
                                         + F_x * ( -2.13981150385256463e-11
                                         + F_x * ( 9.26925723537952145e-12
                                         + F_x * ( -6.66278914581659246e-13
                                         + F_x * ( 4.09694460483010635e-14
                                         + F_x * ( -1.12809387751368198e-15
                                         + F_x * ( 1.6274919899379346e-17
                                                 ))))))))))))))
                                       )
                                     ), 6.0+0.5);
