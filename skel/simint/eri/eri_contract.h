...
inline void contract(int nlanes, int ncart,
                     int const * const restrict offsets,
                     ...
                     double * const restrict PRIM_PTR)
{
    ...
    for(n = 0; n < nlanes; ++n)
    {
        ...
        double * const restrict prim_ptr_tmp = PRIM_PTR + offsets[n]*ncart;
...
inline void contract_all(int nlanes, int ncart,
                         __m256d const * const restrict PRIM_INT,
                         double * const restrict PRIM_PTR)
{
    int n, n4;
